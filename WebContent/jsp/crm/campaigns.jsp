...
<ul id="campaignList" data-role="listview" data-filter="true" data-filter-placeholder="<s:text name="title.listCampaign" />..." data-inset="true">
  <s:iterator value="campaigns" id="campaign">
    <li><a href="getCampaign.action?id=<s:property value="#campaign.id"/>"><s:property value="#campaign.name"/></a></li>
  </s:iterator>
</ul>
