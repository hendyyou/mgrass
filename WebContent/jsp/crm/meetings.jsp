...
<div id="meetingspage" data-role="page">
...
<header data-role="header" data-theme="b" data-position="inline">
  ...
  <h1><s:text name='title.grid.meetings'/></h1>
  <a href="../../j_spring_security_logout" data-icon="delete"><s:text name="link.logout" /></a>
</header>

<div data-role="content" class="content" >

<ul id="meetingList" data-role="listview" data-filter="true" data-filter-placeholder="<s:text name="title.listMeeting" />..." data-inset="true">
