...
<div data-role="page" id="taskpage" data-add-back-btn="true">
<header data-role="header" data-theme="b" data-position="inline">
  <a href="<s:url action="listTaskPage" namespace="/jsp/crm"/>" data-icon="arrow-l" data-rel="back" ><s:text name="link.back" /></a>  
  <h1><s:text name="entity.task.label"/>:<s:property value="task.name"/></h1>
  ...
  <s:form id="addObjectForm" validate="true" namespace="/jsp/crm" method="post">
	...
	<ul data-role="listview" data-theme="d" style="margin-bottom: 0" data-inset="false">
	  <li>
	    ...
	    <h3 style="margin-top:0"><s:property value="task.subject"/></h3>
      </li>
      <li>
   ...
   <div data-role="collapsible" data-collapsed="false" data-inset="false" data-mini="true" data-theme="b" data-content-theme="d" >
	 ...
	 <ul data-role="listview" data-theme="d" style="margin-bottom: 0" data-inset="false">
       ...
       <li>
	     <h3 class="ui-disabled" style="margin:0 inherit"><s:text name="task.due_date.label"/>:</h3>
	     <h3 style="margin-top:0"><s:property value="dueDate"/></h3>
	   </li>
       <li>
       ...
       <li>
         <a href="getContact.action?id=<s:property value="contactID"/>">
	       <h3 class="ui-disabled" style="margin:0 inherit"><s:text name="entity.contact.label"/>:</h3>
	       <h3 style="margin-top:0"><s:property value="contactText"/></h3>
	     </a>
	   </li>
       <li>
	...
	<div data-role="collapsible" data-collapsed="true" data-inset="false" data-mini="true" data-theme="b" data-content-theme="d" >
	  ...
	  <ul data-role="listview" data-theme="d" style="margin-bottom: 0" data-inset="false">
	   <li>
	     ...
	     <h3 style="margin-top:0"><s:property value="task.description"/></h3>
       </li>
       <li>
	     <h3 class="ui-disabled" style="margin:0 inherit"><s:text name="entity.notes.label"/>:</h3>
	     <h3 style="margin-top:0"><s:property value="task.notes"/></h3>
	   </li>
       <li>
